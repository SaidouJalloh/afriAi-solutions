...
export const teamMembers: TeamMember[] = [
    // — Équipe de Direction —
    {
        ...
        name: "A. Wahab Diallo",
        role: "Co-fondateur & CEO",
        background: "Enseigant Chercheur en ML",
        image: "/wahab.JPG",
        linkedin: "https://www.linkedin.com/in/abdoul-wahab-diallo-b81345168/",
    },
    {
        ...
        name: "Y. Mouhoumed Elmi",
        role: "Co-fondateur & COO",
        background: "PhD Student | Expert IA & S&E",
        image: "/yacin.jpeg",
        linkedin: "https://www.linkedin.com/in/yacin-mouhoumed-elmi-6a157287/",
    },
    {
        id: 2,
        name: "L. Mbagdje Dorenan",
        role: "Co-fondatrice & Tech Lead",
        background: "Ingénieure IA & Data Scientist",
        image: "/lauriane.jpg",
        linkedin: "https://www.linkedin.com/in/lauriane-mbagdje-dorenan/",
    },
       {
    ...
    },
    {
        id: 7,
        name: "Oumar Kra",
        role: "Co-fondateur & CGO",
        background: "Expert IA, Télécoms & S&E",
        image: "/oumar.jpg",
        linkedin: "https://www.linkedin.com/in/oumar-kra-a4012a128/",
    },
 ...
 
    {
        ...
        name: "Tony Sarre",
        role: "Data Scientist",
        background: "PhD Student | Modélisation Avancée",
        image: "/tony.jpeg",
        linkedin: "https://www.linkedin.com/in/tony-sarre-0b4236129/",
    },
    // {
    ...
    //     name: "Yaya Toure",
    //     role: "Data Analyst",
    //     background: "Ingénieur Modeling & IA",
    //     image: "/yaya.jpeg",
    //     linkedin: "#",
    // },
    {
        id: 6,
        name: "P. Marcelle Elanga",
        role: "Data Scientist & Partenariats",
        background: "Ingénieure IA & IoT Specialist",
        image: "/marcelle.jpg",
        linkedin: "https://www.linkedin.com/in/paule-marcelle-elanga-7a21781a3/",
    },
];
                        ...
                        <div className={styles.memberCard}>
                            ...
                            <div className={styles.memberInfo}>
                                <div className={styles.memberDetails}>
                                    <h3 className={styles.memberName}>{member.name}</h3>
                                    <p className={styles.memberRole}>{member.role}</p>
                                    <p className={styles.memberBackground}>{member.background}</p>
                                </div>
